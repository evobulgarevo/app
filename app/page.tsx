...
const QUESTIONS = [
  { id: 'idea', label: 'WHAT PAIN POINT DOES YOUR IDEA SOLVE?', placeholder: 'e.g. reduces churn for SaaS companies...', type: 'input' },
  { id: 'traction', label: 'WHAT IS YOUR CURRENT TRACTION?', placeholder: 'e.g. 50 beta users, $2K MRR, just an idea...', type: 'input' },
  { id: 'technical', label: 'CAN YOU BUILD THIS YOURSELF?', options: ['Yes — I am technical', 'Partly — some technical skills', 'No — I need a technical co-founder'], type: 'select' },
  { id: 'team', label: 'TEAM SIZE', options: ['Solo founder', '2 founders', '3+ founders'], type: 'select' },
  { id: 'speed', label: 'HOW FAST HAVE YOU MOVED SO FAR?', options: ['Idea only — nothing built yet', 'Built something in < 1 month', 'Shipping and iterating weekly'], type: 'select' },
]
          ...
          <div className="main-content">
            <div className="hero-stack">
              ...
              <div className="validate-box">
                <div className="systems-go">ALL SYSTEMS GO</div>
